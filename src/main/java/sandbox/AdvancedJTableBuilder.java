...
public class AdvancedJTableBuilder<T> {
     ...
     *
     * @param list the content data
     * @param resultsPerPage Number of items to be displayed per page
     * @return itself
     */
    public AdvancedJTableBuilder<T> withData(List<T> list, int resultsPerPage) {
        ...
        this.paginator = new ListPaginator<>(list, resultsPerPage);
        return this;
    }
    ...
    public NewSelectTable<T> create() {
        ...
        return new NewSelectTable<>(model, paginator);
    }
